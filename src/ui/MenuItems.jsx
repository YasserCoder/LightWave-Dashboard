        ...
        <li className="mb-2 whitespace-break-spaces">
            {children ? (
                <>
                    ...
                    >
                        <button
                            className="hover:text-colored text-start"
                    ...
                    {isOpen && (
                        <ul className="pl-4 mt-2 relative z-40">
                            <span className="absolute h-full w-[2px] left-1 top-0 bg-colored"></span>
                            {children}
                        </ul>
                    )}
                </>
                ...
                <button
                    className="block p-2 hover:text-colored rounded text-start"
                    onClick={(event) => {
